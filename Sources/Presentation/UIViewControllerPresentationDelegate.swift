...
protocol UIViewControllerPresentationDelegate: NSObject {
	@MainActor func viewControllerDidDismiss(_ presentingViewController: UIViewController?, animated: Bool)
}
...
extension UIViewController {
	...
	var presentationDelegate: UIViewControllerPresentationDelegate? {
		get {
			guard let obj = objc_getAssociatedObject(self, &Self.presentationDelegateKey) as? ObjCWeakBox<NSObject>
			else { return nil }
